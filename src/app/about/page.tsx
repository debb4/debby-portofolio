        ...
        <Column className={styles.blockAlign} flex={9} maxWidth={40}>
          ...
          {about.technical.display && (
            <>
              ...
              <Flex wrap gap="8" marginBottom="40">
                {about.technical.skills.map((skill, index) => (
                  <Flex
                    ...
                    gap="8"
                    vertical="center"
                    className="hover:border-brand-medium transition-colors duration-200"
                  >
                    <Icon name={skill.icon} size="m" />
                    <Text variant="body-default-m">{skill.name}</Text>
                  </Flex>
                ))}
              </Flex>
            </>
